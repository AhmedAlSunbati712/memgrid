...
def run_suite(*, input_dir: Path, output_dir: Path, max_settings: int | None = None, max_dam_orders: int | None = None) -> list[Path]:
    output_dir.mkdir(parents=True, exist_ok=True)
    selected_settings = [setting.name for setting in SETTING_SPECS[: max_settings or len(SETTING_SPECS)]]
