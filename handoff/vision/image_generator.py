...
def corrupt_image(
    ...
    *,
    ...
    if mode == "noise_shift_occlusion":
        shifted = perturb_image(image, noise_std=noise_std, max_shift=max_shift, seed=seed)
        return _occlude_image(shifted, occlusion_frac=occlusion_frac, seed=seed)
    if mode == "occlusion":
