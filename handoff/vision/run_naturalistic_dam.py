...
def run_naturalistic_dam(
    *,
    ...
    effective_n_seeds = int(settings["n_seeds"]) if n_seeds is None else n_seeds
    effective_storage_sizes = (
        settings["storage_sizes"] if storage_sizes is None else storage_sizes
    )
    ...
    split_specs = build_category_split_specs(
        ...
        storage_sizes=effective_storage_sizes,
